...
![Project Preview](./src/Banner/readme.png)
...
You can see the live demo of the portfolio website [here](https://NataffCH.github.io/). -->
...
1. Clone the repository:
   ...
   ```
   git clone https://github.com/NataffCH/nathan-portfolio-ts.git
   ```
...
- Email: nathanaffolter@proton.me
